        ...
        <div class="flex items-center justify-between py-4">
            ...
            <div class="flex items-center gap-2">
                <Button size="small" @click="addUser">
                    ...
                    添加账号</Button>
                <Button size="small" @click="handleOpenMhyy">
                    <img src="https://m.mhdyp.com/static/img/login.17b3f1d.png" class="w-4 h-4"
                        style="border-radius: 50%;" alt="">
                    麻花影院
                </Button>
            </div>
            ...
            <div class="flex flex-col gap-1 p-1 rounded-1 hover:bg-#f5f6f7 border-dashed  border-b-1px border-#b2b2b2"
                ...
                <div class="flex justify-between items-center">
                    <div class="flex gap-1 items-center">
                        <Tag severity="info" class="text-sm" size="small" value="系统" v-if="log.channel == 'sys'"></Tag>
...
onMounted(async () => {
    document.title = `闲鱼IM`
    isReady.value = true
    window.electron.ipcRenderer.on('log', (_, payload: LogItem) => {
    ...
    window.electron.ipcRenderer.on('user_refresh', () => {
        syncUserList()
    })
    syncUserList()
})
